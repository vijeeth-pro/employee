...
from app.api.v1 import auth, users, companies, employees, vendor_companies, vendor_employees, analytics, policy, rag
...
api_router.include_router(policy.router, prefix="/policy", tags=["Company Policies"])
